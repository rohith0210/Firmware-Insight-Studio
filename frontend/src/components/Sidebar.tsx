...
const GROUPS: { lbl: string; items: { id: View; t: string; ic: string; locked?: boolean }[] }[] = [
  ...
  { lbl: "FIRMWARE", items: [{ id: "callgraph", t: "Call Graph", ic: "⑂" }, { id: "linker", t: "Linker Script", ic: "⌗", locked: true }] },
  ...
  return (
    <aside className="side">
      <div className="brand">
        ...
        <div><h1 className="fg">FIRMWARE<br />INSIGHT</h1><small className="mut">workbench v1.1</small></div>
      </div>
      {GROUPS.map(g => (
