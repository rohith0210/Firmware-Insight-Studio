        ...
        if (data && data.lines && data.lines.length > 0) {
          ...
          setDynSource({
            lines: [
              ...
              { num: 5, text: "void Error_Handler(void);" },
              { num: 6, text: "void MX_GPIO_Init(void);" },
              { num: 7, text: "void TIMER4_Init(void);" },
              { num: 8, text: "void GPIO_Init(void);" },
              { num: 9, text: "" },
              { num: 10, text: `int ${activeSym.name}(void)` },
              { num: 11, text: "{" },
              { num: 12, text: "    /* Reset of all peripherals, Initializes the Flash interface and the Systick. */" },
              ...
              { num: 20, text: "    TIMER4_Init();" },
              { num: 21, text: "" },
              { num: 22, text: "    /* Start hardware timer */" },
              { num: 23, text: "    HAL_TIM_Base_Start(&htim4);" },
              { num: 24, text: "" },
              { num: 25, text: "    while (1)" },
              { num: 26, text: "    {" },
              { num: 27, text: "        /* App Super-loop */" },
              { num: 28, text: "    }" },
              { num: 29, text: "}" },
            ],
            filename: `${activeSym.name}.c`,
